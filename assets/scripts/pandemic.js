                    ...
                    for (var i = 0; i < items.length; i++) {
                        ...
                        if (typeof item.selfCooLat !== 'undefined' &&
                            ...
                            markerData.push({
                                ...
                                title: item.label,
                                icon: getIcon('ff0000'),
                                description: '<strong>Notes:</strong></br>' + item.descriptionTitle + '<br/><strong>First contact in Latvia:</strong> ' + item.dateOfFirstContactWithLatvia + '<br/><strong>Broadcasted:</strong> ' + item.dateOfDiagnosisBroadcast + '<br/><strong>Sources:</strong><ol><li><a href="http://latvijaskoronakarte.online">latvijaskoronakarte.online</a></li><li><a href="' + item.link + '" target="_blank">' + item.link + '</a></li>' + (item.extraLink1 ? '<li><a href="' + item.extraLink1 + '" target="_blank">' + item.extraLink1 + '</a></li>' : '') + '' + (item.extraLink2 ? '<li><a href="' + item.extraLink2 + '" target="_blank">' + item.extraLink2 + '</a></li>' : '') + '' + (item.extraLink3 ? '<li><a href="' + item.extraLink3 + '" target="_blank">' + item.extraLink3 + '</a></li>' : '') + '</ol>',
                                subtitle: item.origin == 'Saslimšanas Vieta Nav Publicēta' ? '' : item.origin,
