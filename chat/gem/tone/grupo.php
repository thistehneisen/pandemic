...
{
background: url(gem/ore/grupo/global/drag.svg) no-repeat;
height: 60px;
...
i.gr-like
{
background: url(gem/ore/grupo/global/like.svg)no-repeat;
background-position: center;
background-size: 85%;
transition: 0.5s;
}
...
i.gr-download
{
background: url(gem/ore/grupo/global/download.svg)no-repeat;
background-position: center;
background-size: 85%;
}
...
i.gr-reply
{
background: url(gem/ore/grupo/global/reply.svg)no-repeat;
background-position: center;
background-size: 85%;
}
...
i.gr-remove
{
background: url(gem/ore/grupo/global/remove.svg)no-repeat;
background-position: center;
background-size: 85%;
}
...
i.gr-report
{
background: url(gem/ore/grupo/global/report.svg)no-repeat;
background-position: center;
background-size: 85%;
}
...
.gr-gif
{
background: url('gem/ore/grupo/global/gif.svg')no-repeat;
background-position: center;
background-size: 85%;
}
...
.gr-qrcode
{
background: url('gem/ore/grupo/global/qrcode.svg')no-repeat;
background-position: center;
background-size: 85%;
}
...
.gr-mic .mstart
{
background: url(gem/ore/grupo/global/mic.svg)no-repeat;
background-position: center;
background-size: 80%;
border: 0px;
width: 100%;
...
.swr-grupo .panel > .textbox > .box > .icon > i.gr-mic > .mstop
{
display: none;
background: url(gem/ore/grupo/global/record.svg)no-repeat;
background-position: center;
background-size: 80%;
border: 0px;
width: 100%;
...
.swr-grupo .panel > .textbox > .box > .icon > i.gr-mic > .mstop > span
{
font-style: normal;
font-weight: 600;
display: inline-block;
...
.swr-grupo .panel > .textbox > .box > .icon > i.gr-mic > .mstop > i
{
position: relative;
top: 1px;
display: inline-block;
...
.swr-grupo .panel > .textbox > .box > .icon > i.gr-mic > .mstop > span > i
{
font-style: normal;
display: inline-block;
width: 8px;
...
{
background: #333 url(gem/ore/grupo/global/error.svg)no-repeat;
background-position: center;
background-size: 50px;
}
