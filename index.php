			...
			<div class="modal-container">
				<div class="modal-wrapper">
					...
					<div class="modal-content bodytext">
						...
						<ul>
							<li><img src="<?php print($fullAddress)?>assets/images/markers/red.png" alt="Red locations" /> <span style="color: #ff0000;">Red locations</span> are data that are defining where someone that's been COVID-19 positive, has originated from. Not their current or actual location.</li>
							<li><img src="<?php print($fullAddress)?>assets/images/markers/green.png" alt="Green locations" /> <span style="color: #00ff54;">Green locations</span> are just people that are using this platform. It's anyone that has authorized their Facebook profile, and shared their location. It can be even you. These points are not defining their health status at any way. You can change your information in "<em>Profile</em>" section, once authorized.</li>
							<li><img src="<?php print($fullAddress)?>assets/images/markers/blue.png" alt="Blue locations" /> <span style="color: #00aeef;">Blue locations</span> are services, volunteers, anything that every authorized user can publish on the map using the "<em>Add service</em>" section.</li>
						</ul>
					</div>
				</div>
			</div>
